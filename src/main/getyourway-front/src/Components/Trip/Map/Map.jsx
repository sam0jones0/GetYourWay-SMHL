...
function Map(props) {
  ...
  const [destination, setDestination] = useState(
    new window.google.maps.LatLng(props.destination)
  );
  ...
  // Airport Polyline
  const path = [origin, props.destination];
  ...
  const options = {
    ...
    editable: false,
    visible: true,
    paths: [origin, props.destination],
  };
    ...
    <div className=".container-fluid customMap">
      ...
      >
        ...
        {origin != null && destination != null && (
          <Polyline onLoad={onLoadPolyline} path={path} options={options} />
        )}
        {origin != null && destination != null && (
          <Marker
            onLoad={onLoadMarker}
